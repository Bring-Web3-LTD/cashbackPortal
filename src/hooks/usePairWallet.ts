 ...
 *
 * Shared by both portals, hence `src/hooks/` rather than either view's folder.
 * Input mechanics for the OTP boxes live in components/PairWalletModal/
 * useOtpInputs; the mobile sheet's wiring of the two is usePairWalletModal in
 * the same folder.
 */
